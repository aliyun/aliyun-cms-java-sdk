...
import com.aliyun.openservices.cms.metric.reservoir.WeightedSnapshot.WeightedSample;
...
//    private static final double DEFAULT_ALPHA = 0.015;
     ...
     * @param level
     */
    public ExponentiallyDecayingReservoir(RecordLevel level) {
        this(132, alphaCalu(level));
    }

    static double alphaCalu(RecordLevel level) {
        switch (level) {
            case _15S:return 0.05;
            case _60S:return 0.09;
            case _300S:return 0.1;
    ...
    public void reset() {
        ...
        try {
            ...
            this.count.set(0);
            this.startTime = currentTimeInSeconds();
            this.nextScaleTime.set(clock.getTick() + RESCALE_THRESHOLD);
        }finally {
            unlockForRescale();
        }
    }
